...
const vec4 NEON_GREEN = vec4(0., 1.0, 0.612, 1.0); // #00FF9C 
const vec4 NEON_BLUE = vec4(0.239, 0.353, 0.996, 1.0); // #3d5afe
const vec4 HIGHLIGHT_BLUE = vec4(0.176, 0.247, 0.463, 1.0); // #2d3f76
const vec4 HIGHLIGHT_PURPLE = vec4(0.192, 0.106, 0.573, 0.5); // #311b92

const vec4 TRAIL_COLOR = NEON_BLUE;
const vec4 TRAIL_COLOR_ACCENT = NEON_GREEN;
// const vec4 TRAIL_COLOR = vec4(0.482, 0.886, 1.0, 1.0);
// const vec4 TRAIL_COLOR_ACCENT = vec4(0.0, 0.424, 1.0, 1.0);
const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
const float DURATION = 0.3;
const float SMOOTH_STEP = 0.0015; //originally 0.003
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    newColor = mix(newColor, TRAIL_COLOR_ACCENT, 1.0 - smoothstep(cCursorDistance, -0.000, SMOOTH_STEP * (1. - progress)));
    newColor = mix(newColor, CURRENT_CURSOR_COLOR, 1.0 - smoothstep(cCursorDistance, -0.000, SMOOTH_STEP * (1. - progress)));
