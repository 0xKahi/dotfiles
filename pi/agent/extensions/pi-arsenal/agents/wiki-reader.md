...
metadata:
  ...
  - "Purpose: help navigate and find relevant concepts in the llm-wiki, so you dont have to"
  - "**USE WHEN:** you need to discover relevant concepts in llm-wiki • when user ask for information in the llm-wiki"
  - "**AVOID WHEN:** updating/creating concepts in llm-wiki • llm-wiki search was not explicitly requested by user"
---
