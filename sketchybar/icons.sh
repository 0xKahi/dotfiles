...
# Aerospace Icons
ICON_AEROSAPCE_ACCORDIAN=􀏭
ICON_AEROSAPCE_FULLSCREEN_ZOOM=􀂓
ICON_AEROSAPCE_PARENT_ZOOM=􀥃
ICON_AEROSAPCE_FLOAT=􀢌
ICON_AEROSAPCE_TILES=󰝘
ICON_AEROSAPCE_MAIN_MODE=󰰑
ICON_AEROSAPCE_SERVICE_MODE=󰰣
ICON_AEROSAPCE_WINDOW_MODE=󰰯
ICON_AEROSAPCE_RESIZE_MODE=󰰠
...
export ICON_CHAT=󰻞 # messages, slack, teams,
