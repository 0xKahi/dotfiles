...
# Color Tokens
BAR_COLOR=$(getcolor black 80)
BAR_BORDER_COLOR=$(getcolor black 0)
HIGHLIGHT=$(getcolor green)
HIGHLIGHT_75=$(getcolor green 75)
HIGHLIGHT_50=$(getcolor green 50)
HIGHLIGHT_25=$(getcolor green 25)
HIGHLIGHT_10=$(getcolor green 10)
ICON_COLOR=$(getcolor white)
ICON_COLOR_INACTIVE=$(getcolor white 25)
LABEL_COLOR=$(getcolor bright_white)
